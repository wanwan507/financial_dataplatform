define(["comp/common/collapse",
    ...
    var DatabaseUploadPanel = React.createClass({
        render: function(){
            return (
                <div>
                    <a href="http://127.0.0.1:8080">DB2</a><br/>
                    <a href="http://127.0.0.1:8080">SQLite</a><br/>
                    <a href="http://127.0.0.1:8080">MySQL</a><br/>
                    <a href="http://127.0.0.1:8080">PostgreSQL</a>
                </div>
            );
        },
        componentDidMount: function() {
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="panel-group" role="tablist" aria-multiselectable="true">
                            ...
                            <Collapse title="DataBase" id="DatabaseUploadCollapse">
                                <DatabaseUploadPanel></DatabaseUploadPanel>
                            </Collapse>
                        </div>
                    </div>
